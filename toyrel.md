...
これでCommon.fsの内容をそこに書いて実行したかのように振る舞います。
...
この辺はREPL driven developmentで行きたい所。

{% capture repldriven %}
**REPL driven developmentト**  

ここにREPL driven developmentの話を書く

まずはScratch.fsxでコードを書いていって、ある程度動作が確認出来たらmodul
